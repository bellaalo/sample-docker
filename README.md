...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/bellaalo/sample-docker.git
    ```
...
NB : on the Docker Build & Push Satge please add your API key.
...
pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag netflix cloud101/netflix:latest "
                       sh "docker push cloud101/netflix:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image cloud101/netflix:latest > trivyimage.txt" 
            }
        }
        stage('Deploy to container'){
            steps{
                sh 'docker run -d -p 8081:80 cloud101/netflix:latest'
            }
        }
    }
}
